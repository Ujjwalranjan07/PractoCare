            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-gray-800 mb-4">{doctor.qualifications}</p>

                  <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-4">
                    <div className="flex items-center">
                      <Star className="w-5 h-5 text-yellow-400 fill-current mr-1" />
                      <span className="font-semibold">{doctor.rating}</span>
                      <span className="text-gray-700 ml-1">({doctor.reviewCount} reviews)</span>
                    </div>
                  ...
                  <div className="flex items-center justify-center md:justify-start text-gray-800 mb-6">
