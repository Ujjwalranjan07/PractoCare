        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-slate-500 text-lg mt-2">Manage your patient information</p>
            </div>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <Input
              ...
              className="pl-10 bg-white border-slate-200 text-slate-900 placeholder-slate-400 focus:border-teal-500/50"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {patients.map((patient, index) => (
              <Card
                key={patient.id}
                className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-teal-100 bg-gradient-to-br from-white to-teal-50 backdrop-blur-sm"
          ...
          {/* Coming Soon Notice */}
          <Card className="mt-8 border border-teal-100 bg-gradient-to-br from-white to-teal-50 backdrop-blur-sm">
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Full Patient Management Coming Soon</h3>
