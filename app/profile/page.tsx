    ...
    <ProtectedRoute allowedRoles={["patient"]}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-6 border border-blue-500/30 backdrop-blur-sm">
              <User className="w-4 h-4" />
              <span>Patient Profile</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 bg-clip-text text-transparent mb-4 sm:mb-6">
              My Profile
            </h1>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8">
            ...
            >
              <Card className="border border-blue-100 bg-gradient-to-br from-white to-blue-50 backdrop-blur-sm shadow-xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                <CardHeader className="relative border-b border-blue-100 pb-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div className="flex items-center space-x-4 sm:space-x-6">
                      ...
                      >
                        ...
                        <motion.div
                          className="absolute -bottom-1 -right-1 w-8 h-8 bg-white rounded-full flex items-center justify-center border-2 border-blue-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        >
                          ...
                          <div className="relative">
                            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-blue-500" />
                            <Input
                              id="name"
                              type="text"
                              value={formData.name}
                              ...
                              className={`pl-10 bg-white border-blue-200 text-gray-800 placeholder-gray-400 transition-all duration-300 ${
                                isEditing
                      ...
                      <AnimatePresence>
                        {isEditing && (
                          <motion.div
                            className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-blue-100"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0, y: -20 }}
                            transition={{ duration: 0.3 }}
                          >
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                              <Button
                                ...
                                disabled={isLoading}
                                className="w-full sm:w-auto border-blue-200 text-blue-700 hover:bg-blue-50 bg-white/80"
                              >
                                <X className="w-4 h-4 mr-2" />
                                Cancel
                              </Button>
            ...
            <div className="space-y-6">
              ...
              >
                <Card className="border border-blue-100 bg-gradient-to-br from-white to-blue-50 backdrop-blur-sm shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-800 flex items-center">
                      <Activity className="w-5 h-5 mr-2 text-blue-600" />
                      Health Stats
                    </CardTitle>
                    <CardDescription className="text-gray-600">Your health journey overview</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {stats.map((stat, index) => (
                      <motion.div
                        key={stat.label}
                        className="flex items-center justify-between p-3 bg-blue-50/50 rounded-lg hover:bg-blue-100/50 transition-colors duration-300"
              ...
              >
                <Card className="border-0 bg-gradient-to-br from-white/90 to-blue-50/90 backdrop-blur-sm shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold text-gray-800 flex items-center">
