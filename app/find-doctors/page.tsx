              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                {filteredDoctors.map((doctor, index) => (
                  <motion.div
                    ...
                    whileHover={{ y: -5 }}
                  >
                    <Card className="hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-blue-50 backdrop-blur-sm border border-blue-100 shadow-lg overflow-hidden">
                      <CardContent className="p-4 sm:p-6">
                          ...
                          <div className="flex-1 text-center sm:text-left min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3">
                              <div className="mb-2 sm:mb-0">
                                ...
                                <p className="text-xs sm:text-sm text-gray-800 truncate">{doctor.qualifications}</p>
                              </div>
                              <div className="flex items-center justify-center sm:justify-end">
                                <Star className="w-4 h-4 text-yellow-400 fill-current" />
                                <span className="ml-1 text-sm font-semibold">{doctor.rating}</span>
                                <span className="ml-1 text-xs text-gray-700">({doctor.reviewCount})</span>
                              </div>
                            </div>

                            <div className="space-y-2 mb-4">
                              <div className="flex items-center justify-center sm:justify-start text-xs sm:text-sm text-gray-800">
