...
export function ModernNavbar() {
  ...
  return (
    <motion.nav
      className="bg-gray-900 backdrop-blur-lg border-b border-gray-800 sticky top-0 z-50 shadow-md"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/find-doctors"
                className="flex items-center space-x-2 text-gray-300 hover:text-blue-400 transition-colors duration-200 font-medium px-3 py-2 rounded-lg hover:bg-gray-800"
              >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1 bg-gradient-to-br from-white to-blue-50 backdrop-blur-lg border-t border-blue-100">
                <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.1 }}>
                  <Link
                    href="/find-doctors"
                    className="flex items-center space-x-3 px-3 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-100 transition-all duration-200 rounded-lg"
                ...
                {user ? (
                  ...
                  <motion.div
                    className="space-y-3 px-3 py-4 border-t border-blue-100"
                    initial={{ x: -20, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ delay: 0.5 }}
                  >
