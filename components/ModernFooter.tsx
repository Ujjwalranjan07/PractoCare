...
export function ModernFooter() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 text-gray-800 overflow-hidden border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
            ...
            <div className="space-y-2">
              {[
                ...
                >
                  <Link
                    href={link.href}
                    className="block text-gray-700 hover:text-blue-700 hover:bg-blue-50 px-2 py-1 rounded-lg transition-all duration-200 text-sm"
                  >
                    {link.label}
                  </Link>
                </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-700 text-sm">Get health tips and updates delivered to your inbox</p>
            </div>
            <motion.div className="flex space-x-2 w-full md:w-auto" whileHover={{ scale: 1.02 }}>
              <div className="relative flex-1 md:w-64">
                <Input
                  ...
                  className="bg-white/80 border-blue-200 text-gray-800 placeholder-gray-500 rounded-xl backdrop-blur-sm focus:border-blue-500 transition-all duration-300"
                />
              </div>
        ...
        >
          <p className="text-gray-700 text-sm text-center sm:text-left">
            ...
            <Link href="/privacy" className="hover:text-blue-700 transition-colors mx-1">
              Privacy Policy
            </Link>{" "}
            |
            <Link href="/terms" className="hover:text-blue-700 transition-colors mx-1">
              Terms of Service
            </Link>
          </p>
